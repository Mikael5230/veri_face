<template>
  <div ref="containerRef" class="relative flex h-[60rem] items-center justify-center p-2 md:h-[80rem] md:p-20">
    <div class="relative w-full py-10 md:py-40" style="perspective: 2500px">
